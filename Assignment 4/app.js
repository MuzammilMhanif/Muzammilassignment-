let arr = [
  ...
  <h5 class="card-title lead">${brand}</h5>
  <h5 class="card-title lead">${model}</h5>
  <h5 class="card-title lead">${price}</h5>
  <h5 class="card-title lead">${camera}</h5>
  <h5 class="card-title lead">${ram}</h5>
  <h5 class="card-title lead">${rom}</h5>
  <button class="btn btn-warning mt-2" type="button">About Phone</button>
  </div>
  </div>`);
  });
  ...
  function search() {
    ...
    const filteredArray = arr
      ...
      .map(
        ...
        <div class="card-body">
        <div class="card">
        <img src="${devices.image_url}" class="card-img-top" style="height: 15rem;" alt="...">
        <div class="card-body">
        <h5 class="card-title">${devices.model}</h5>
        <h5 class="card-title">${devices.price}</h5>
         <h5 class="card-title">${devices.brand}</h5>
         <button class="btn btn-warning mt-2" type="button">Buy Now</button>
